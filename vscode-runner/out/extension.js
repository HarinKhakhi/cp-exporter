...
function activate(context) {
    ...
    let fetchTestCases = vscode.commands.registerCommand("cp-runner.fetchTestCases", async () => {
    ...
    let runCurrentTestCase = vscode.commands.registerCommand("cp-runner.runCurrentTestCase", () => {
    ...
    let runAllTestCases = vscode.commands.registerCommand("cp-runner.runAllTestCases", () => {
